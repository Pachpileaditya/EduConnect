...
Update the src/main/resources/application.properties file with your MySQL database URL, username, and password:
...
Navigate to the frontend directory in a new terminal: cd frontend
